...
/* SD card and FAT filesystem example.
   ...
   https://docs.freenove.com/projects/fnk0083/en/latest/fnk0083/codes/C/28_Read_and_Write_the_SDcard.html
*/
...
esp_err_t export_binary(const char *path, char *data, size_t data_size) {
    ...
    // Write the array (as raw bytes) to the file
    if (fwrite(data, sizeof(char), data_size, f) != data_size) {
    ...
    ESP_LOGI(TAG, "Wrote %d bytes to %s", data_size, path);
